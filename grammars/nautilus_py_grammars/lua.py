...
ctx.rule(u'FUNCTIONCALL',u'{BASEEXPR}:{IDENTIFIER} {ARGS}')
ctx.rule(u'FUNCTIONCALL',u'{BASEEXPR}.{IDENTIFIER} {ARGS}')
...
ctx.rule(u'EXPR',u'{BASEEXPR}')
ctx.rule(u'EXPR',u'{FUNCTIONCALL}')
ctx.rule(u'BASEEXPR',u'(nil)')
ctx.rule(u'BASEEXPR',u'(false)')
ctx.rule(u'BASEEXPR',u'(true)')
ctx.rule(u'BASEEXPR',u'({NUMERAL})')
ctx.rule(u'BASEEXPR',u'{LITERALSTRING}')
ctx.rule(u'BASEEXPR',u'{TABLECONSTRUCTOR}')
ctx.rule(u'BASEEXPR',u'({VAR}[{EXPR}])')
ctx.rule(u'BASEEXPR',u'({EXPR}{BINOP}{EXPR})')
ctx.rule(u'BASEEXPR',u'({UNOP}{EXPR})')
ctx.rule(u'BASEEXPR',u'{LAMBDA}')
ctx.rule(u'BASEEXPR',u'{VAR}')
ctx.rule(u'BASEEXPR',u'{FUNCTIONCALL}')
ctx.rule(u'BASEEXPR',u'({EXPR})')
ctx.rule(u'BASEEXPR',u'...')
ctx.rule(u'BINOP',u'+')
ctx.rule(u'BINOP',u'-')
ctx.rule(u'BINOP',u'*')
ctx.rule(u'BINOP',u'/')
